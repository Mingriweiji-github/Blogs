...
[一个快速定位iOS包问题的脚本](https://www.jianshu.com/p/1bac4464e3e4)

[watermark_icon.sh](https://github.com/summertian4/ZLYWatermarkIcon)是一个可以帮助快速定位 commit 的脚本，可以用用于 Xcode Run Script 中。

[watermark_icon.sh](https://github.com/summertian4/ZLYWatermarkIcon)可以为在 build 后将原有的图标覆盖上 `添加了 build 号、commit 的 hash 值、分支名的` 水印。
...
- [M1非越狱环境WeChat插件注入之旅](https://mp.weixin.qq.com/s/v6MGlOoLmbumWt8mpMUT8w)
- 

飘云阁2004年12月01日成立于湖南长沙，专注于Windows、Linux、iOS、Android平台的逆向工程研究，为各位技术爱好者提供一个氛围良好的交流与合作平台，并由国内知名安全公司大神共同维护，多年来，为相关企业输送了众多优秀人才，堪称逆向工程师摇篮。同时，飘云阁拥有多年的线上免费教学经验，对最新掌握的技术倾囊相授，旨在带领爱好者快速踏入逆向之门。出版了《iOS应用逆向与安全之道》。
...
- [Medium iOS](https://medium.com/topic/ios-development)
- 



- [bestswifte：Swift 汇编（一）Protocol Witness Table 初探](https://mp.weixin.qq.com/s/dvWVnU7ZWiSIvQZBhWXnSw)
...
- [参考Provider文档](https://pub.dev/documentation/provider/latest/provider/provider-library.html)
